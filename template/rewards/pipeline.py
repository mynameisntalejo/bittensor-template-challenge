...
class RewardPipeline:
    ...
    def validate_tasks(self):
        ...
        for task in self.selected_tasks:
            if task != "math":
                raise ValueError(
                    f"Task {task} not supported. Only 'math' task is supported."
                )
    ...
    def _check_weights(self, task, definition, expected_weight):
        ...
        model_infos = getattr(MathTask, definition)
    ...
    def load_pipeline(self):
        ...
        for task in self.selected_tasks:
            active_reward_models += MathTask.reward_definition
            active_reward_models += MathTask.penalty_definition
