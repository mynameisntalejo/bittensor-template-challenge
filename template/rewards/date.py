...
from template.rewards import BaseRewardModel, BatchRewardOutput, RewardModelTypeEnum
...
class DateRewardModel(BaseRewardModel):
    ...
    def parse_dates_from_text(self, text: str) -> tuple:
        ...
        date_patterns = [
            ...
            r"\b(\d{1,2}) (January|February|March|April|May|June|July|August|September|October|November|December) (\d{3,4})\b",
            # DD Month, YYYY
            r"\b(January|February|March|April|May|June|July|August|September|October|November|December) (\d{1,2})(,\s*)?(\d{3,4})\b",
            # Month DD, YYYY
        ]
